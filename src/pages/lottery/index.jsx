        ...
        <>
            <NavLink to={`/donation/auction?[${RecEventID}]`}>
                <div style={{ display: 'flex', gap: '14px', position: 'absolute', right: '208px' }} >
                    <div className="card" style={{ color: 'white', overflow: 'hidden', background: 'rgb(236, 201, 0)', textAlign: 'center', width: '200px', cursor: 'pointer', height: '48px', margin: '0', padding: '0px' }}>
